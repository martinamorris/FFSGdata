...
nrow(filter(fe_harmonized_2013 , is.na(state)))
nrow(filter(fe_harmonized_2013 , is.na(name)))
nrow(filter(fe_harmonized_2013 , is.na(sex)))
nrow(filter(fe_harmonized_2013 , is.na(race)))
