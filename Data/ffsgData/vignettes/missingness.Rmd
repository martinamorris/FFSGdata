...
## Fatal Encounters
```{r}
datatable(make_freq_table(fe$name, 3))
datatable(make_freq_table(fe$age, 3))
datatable(make_freq_table(fe$race, 3))
datatable(make_freq_table(fe$sex, 3))
datatable(make_freq_table(fe$zip, 3))
datatable(make_freq_table(fe$date, 3))
```

## Mapping Police Violence
```{r}
datatable(make_freq_table(mpv$name, 3))
datatable(make_freq_table(mpv$age, 3))
datatable(make_freq_table(mpv$race, 3))
datatable(make_freq_table(mpv$sex, 3))
datatable(make_freq_table(mpv$zip, 3))
datatable(make_freq_table(mpv$date, 3))
```

## Killed By Police
```{r}
datatable(make_freq_table(kbp$name, 3))
datatable(make_freq_table(kbp$age, 3))
datatable(make_freq_table(kbp$race, 3))
datatable(make_freq_table(kbp$sex, 3))
datatable(make_freq_table(kbp$zip, 3))
datatable(make_freq_table(kbp$date, 3))
```
