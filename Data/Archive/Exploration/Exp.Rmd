...
kbp_num_records_before_2013 <- nrow(filter(kbp, year(kbp$Date) < 2013)) #there is no year column
fe_num_records_after_2013 <- nrow(filter(fe.clean, fe.clean$year >= 2013))
kbp_num_records_after_2013 <- nrow(filter(kbp, year(kbp$Date) >= 2013))
