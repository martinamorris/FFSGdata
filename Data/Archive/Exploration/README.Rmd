...
p.raw <- plot_ly(data, x = ~dfs, y = ~before_2013, type = 'bar', name = 'Before 2013',
  ...
  add_trace(y = ~after_2013, name = 'After 2013', marker = list(color = 'rgb(26, 118, 255)')) %>%
    layout(title = "Number of records as partiitoned by the origin date of most recently created dataset",
           yaxis = list(title = "Number of records"), xaxis = list(title = " Raw Dataset"), barmode = 'group', bargap = 0.15)
p.raw
...
p.har <- plot_ly(hdata, x = ~hdfs, y = ~hbefore_2013, type = 'bar', name = 'Before 2013',
  ...
  add_trace(y = ~hafter_2013, name = 'After 2013', marker = list(color = 'rgb(26, 118, 255)')) %>%
    layout(title = "Number of records as partiitoned by the origin date of most recently created dataset",
           yaxis = list(title = "Number of records"), xaxis = list(title = "Harmonized Dataset"), barmode = 'group', bargap = 0.15)
p.har
